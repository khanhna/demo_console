...
namespace ConsoleNetFrame.DevicesIntegration.Printer
{
    public class DevMode
    {
        ...
        public struct PRINT_SETTING
        {
            ...
            public PRINT_SETTING Clone() => new PRINT_SETTING()
            {
                PaperSize = PaperSize,
        ...
        struct DEVMODEW
        {
            ...
            //public const int EX_DEV_SIZE = 28;
        }
        ...
        public static void ExDevModeTopSearch()
        {
            ...
            lpDevModeDmW = new IntPtr(GlobalLock(hDevMode));
            ResultCode = DocumentProperties(0, hPrinter.ToInt32(), PrinterName, lpDevModeDmW, IntPtr.Zero, DM_OUT_BUFFER);
            if (ResultCode < 0)
            {
